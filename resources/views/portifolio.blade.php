    ...
    <div class="container">
        ...
        <ul class="nav nav-pills">
            ...
            <li class="filter" data-filter="web">
                <a href="#noAction">Calhas</a>
            </li>
            <li class="filter" data-filter="photo">
                <a href="#noAction">Rufos</a>
            </li>
            <li class="filter" data-filter="photo">
                <a href="#noAction">Cumeeiras</a>
            </li>
            <li class="filter" data-filter="photo">
                <a href="#noAction">Condutor</a>
            </li>
            <li class="filter" data-filter="photo">
                <a href="#noAction">Telhados</a>
            </li>
            <li class="filter" data-filter="identity">
                <a href="#noAction">Exaustor Aeólico</a>
            </li>
            <li class="filter" data-filter="identity">
                <a href="#noAction">Telha Dupla</a>
            </li>            
            <li class="filter" data-filter="identity">
                <a href="#noAction">Estrutura Metálica</a>
            </li>
        </ul>
                    ...
                    <div class="span6">
                        <div class="project-description">
                            <div class="project-title clearfix">
                                <h3>{{ $servicos[$i]['thumb_title'] }}</h3>
                                <span class="show_hide close">
                                    <i class="icon-cancel"></i>
                                </span>
                            </div>
                            <div class="project-info">
                                <p>{{ $servicos[$i]["text_description"] }}</p>
                                <div>
                                    <a href="#" class="btn btn-primary button-primary">{{ $servicos[$i]["text_title_button"] }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
